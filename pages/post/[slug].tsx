...
function Post( { post }: Props){
    ...
    return (
                ...
                <PortableText 
                    ...
                    serializers={{
                        ...
                        link: ({ href, children }: any) => (
                            <a href={href} className="text-blue-500 hoover:underline">
                                {children}
                            </a>
                        )
                    }}
        ...
        {submitted ? (
            ...
            <h3 className="text-sm text-yellow-500">Enjoyed this artice?</h3>
            ...
            <input 
            type="submit"
            className="shadow bg-yellow-500 hover:bg-yellow-400 focus:shadw-outline focus:outline-none text-white font-bold py-2 px-4 rounded cursor-pointer"/>
        </form>
        )}
...
export const getStaticProps: GetStaticProps = async({ params }) => {
    const query = `*[_type == "post" && slug.current == $slug][0]{
        ...
        return {
            ...
            revalidate: 60, //after 60 seconds, it'll update the cached version
        }
    }